...
import br.com.devx.scenery.manager.SceneryFinder;
...
public class SceneryFinderTest extends TestCase {
    ...
    public void testNotFound() {
        doTest("notfound.do", new HashMap(), null, null);
    }

    public void testSampleFind() {
        doTest("sample1.do", new HashMap(), "sample1.jsp", "sample1.scn");
    }

    public void testSameTemplate() {
        HashMap case1 = newMap("param", "1");
        HashMap case2 = newMap("param", "2");

        doTest("sameTemplate.do", new HashMap(), "default.jsp", "default.scn");
    ...
    public void testSameData() {
        ...
        doTest("sameData.do", new HashMap(), "default.jsp", "default.scn");
    ...
    public void testMixed() {
        HashMap case1 = newMap("param", "1");
        HashMap case2 = newMap("param", "2");
        HashMap case3 = newMap("param", "3");
        HashMap case4 = newMap("param", "4");

        doTest("mixed.do", new HashMap(), "default.jsp", "default.scn");
    ...
    public void testEachCase() {
        ...
        doTest("eachCase.do", new HashMap(), "default.jsp", "default.scn");
    ...
    private void doTest(String uri, HashMap parameters, String expectedTemplate, String expectedData) {
    ...
    private HashMap newMap(String param, String value) {
